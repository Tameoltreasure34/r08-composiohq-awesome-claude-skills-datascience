        ...
        ### Derived from [ComposioHQ/awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills)
        ...
        > **Adaptation of `ComposioHQ/awesome-claude-skills` for Data Science & AI/ML use cases.**
        > Source focus: _Composio integrations, 500+ app connections, real actions_
...
```
        ...
        **[ComposioHQ/awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills)**
        which focuses on: _Composio integrations, 500+ app connections, real actions_.
